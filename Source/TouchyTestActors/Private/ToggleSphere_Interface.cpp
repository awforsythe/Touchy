#include "ToggleSphere_Interface.h"
...
AToggleSphere_Interface::AToggleSphere_Interface(const FObjectInitializer& ObjectInitializer)
...
void AToggleSphere_Interface::OnConstruction(const FTransform& Transform)
{
...
void AToggleSphere_Interface::Used_Implementation(APawn* Pawn)
{
...
void AToggleSphere_Interface::UpdateMesh()
{
