#include "ToggleSphere_Inheritance.h"
...
AToggleSphere_Inheritance::AToggleSphere_Inheritance(const FObjectInitializer& ObjectInitializer)
...
void AToggleSphere_Inheritance::OnConstruction(const FTransform& Transform)
{
...
void AToggleSphere_Inheritance::Used(APawn* Pawn)
{
	...
	// Call the base class implementation so Blueprints will still be notified
	Super::Used(Pawn);
}

void AToggleSphere_Inheritance::UpdateMesh()
{
